...
-  Same-region replication: Workflows are seamlessly replicated to a different isolation domain within the same region as the primary Namespace, such as "<ToolTipTerm term="us-east-1" tooltip="The us-east-1 region was Amazon's original and largest region. Many people consider it the 'default' region." />".
