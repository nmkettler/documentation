...
High availability features in Temporal Cloud simplify deployment, ensuring operational continuity and data integrity even during unexpected events impacting an isolation domain or a region using a process called Replication.
...
In the event of network service or performance issues in the active Namespace, your replica is ready to take over.
